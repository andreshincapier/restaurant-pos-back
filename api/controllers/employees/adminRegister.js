  ...
  newAdministrator
    ...
    .then(adminInfo => {
      ...
      if (process.env.NODE_ENV !== 'test') {
        const html = {
          "from": {
            "name": "Restaurante el camaron"
          },
          "to": {
            "name": name,
            "address": email
          },
          "subject": "Welcome to restaurante el camaron",
          "message": mjml2html(`<mjml>
                <mj-head>
            ...
            <mj-body>
              ...
              <mj-section>
                <mj-column>
                  ...
                  <mj-text align="center" font-size="18px" font-weight="bold" font-family="Nunito">${adminInfo.pin}</mj-text>
                </mj-column>
              </mj-section>
            </mj-body>
      </mjml>`).html,
        ...
        const options = {
          method: 'POST',
          url: keys.easymail_url,
          headers: {
            'content-type': 'application/json',
            'X-RapidAPI-Host': keys.easymail_host,
            'X-RapidAPI-Key': keys.easymail_key
          },
          data: html
        };
